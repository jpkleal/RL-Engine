...
This is a byte-for-byte copy of the network class defined in the
...
IMPORTANT: if the real playing service's Model class ever changes
(architecture, checkpoint keys, etc.) this file needs to change with
it, or checkpoints produced by training silently stop being loadable.
Pulling this into a small shared package both services depend on would
remove that drift risk entirely -- worth doing before this goes to
production rather than maintaining two copies by hand.
"""
